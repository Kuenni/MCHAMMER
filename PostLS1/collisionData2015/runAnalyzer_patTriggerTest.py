...
process.TFileService = cms.Service("TFileService",
                                   	fileName=cms.string('jobOutput.root'),
                                   )
...
# switch on the trigger match embedding
switchOnTrigger(process,outputModule = 'RECOSIMoutput')
switchOnTriggerMatchEmbedding( process, [ 'myMatcher' ],outputModule = 'RECOSIMoutput' )

process.patTriggerAnalyzer = cms.EDAnalyzer('PatTriggerAnalyzer',
										patTriggerEvent = cms.InputTag('triggerEventProducery'))
...
process.patTriggerAnalyzer_step = cms.Path(process.patTriggerAnalyzer)
...
process.schedule = cms.Schedule(
							...
							,process.patTriggerAnalyzer_step
