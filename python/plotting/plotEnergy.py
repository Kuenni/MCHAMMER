...
def plotEnergyNormalized(folder, nameOfFile = 'L1MuonHistogram.root'):
	if(folder == None):
	...
	canv.SaveAs("plots/" + folder + "/energyNorm.png")
	canv.SaveAs("plots/" + folder + "/energyNorm.pdf")

	f = TFile.Open("plots/" + folder + "/energyNorm.root","RECREATE")
	canv.Write()
	f.Close()
