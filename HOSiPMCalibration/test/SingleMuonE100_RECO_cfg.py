...
process.hcales_ascii = hcales_ascii = cms.ESSource(
		...
		cms.PSet(
			...
			file = cms.FileInPath('HoMuonTrigger/usercode/HOSiPMAnalysis/data/chan_qual_0.txt')
			),
		cms.PSet(
			object = cms.string('Pedestals'),
			file = cms.FileInPath('HoMuonTrigger/usercode/HOSiPMAnalysis/data/test_pedestals.txt')
			),
		cms.PSet(
			object = cms.string('PedestalWidths'),
			file = cms.FileInPath('HoMuonTrigger/usercode/HOSiPMAnalysis/data/test_pedestalWidths.txt')
			),
		cms.PSet(
			object = cms.string('Gains'),
			file = cms.FileInPath('HoMuonTrigger/usercode/HOSiPMAnalysis/data/test_gains.txt')
			),
		)
	)
